...
public class Wheel : MonoBehaviour {
	...
	//moved this outside of update so other mehtods can see it
	...
	public float getForceOfGroundWheelCollision()
	{
		return Mathf.Sqrt(roadForce.x*roadForce.x + roadForce.y*roadForce.y+roadForce.z*roadForce.z);
	}
