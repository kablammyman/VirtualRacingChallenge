...
public class SoundController : MonoBehaviour {
	...
	//private float carMaxSpeed = 55.0f;//not used
	...
	//private float idleFadeStartSpeed = 3.0f;//not used
	//private float idleFadeStopSpeed = 10.0f;//not used
	//private float idleFadeSpeedDiff = 7.0f; //not used
	//private float speedFadeStartSpeed = 0.0f;//not used
	//private float speedFadeStopSpeed = 8.0f;//not used
	//private float speedFadeSpeedDiff = 8.0f;//not used

	//private bool  soundsSet = false;//not used

	//private float inputFactor = 0;//not used
	private int gear = 0;
	...
	//	tunnelAudio.maxVolume = tunnelVolume;
		...
		//soundsSet = false;//not used
		
		//idleFadeSpeedDiff = idleFadeStopSpeed - idleFadeStartSpeed;//not used
		//speedFadeSpeedDiff = speedFadeStopSpeed - speedFadeStartSpeed;//not used
